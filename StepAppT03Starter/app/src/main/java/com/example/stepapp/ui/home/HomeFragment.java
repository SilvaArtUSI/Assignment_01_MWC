...
public class HomeFragment extends Fragment {
    ...
    private SensorEventListener listener , listenerStepC;

    // TODO 1: ACC sensors.

    private Sensor  mSensorACC , mSensorSC;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mSensorSC =  mSensorManager.getDefaultSensor(Sensor.TYPE_STEP_DETECTOR);

        // TODO 11
        // instantiate the StepCounterListener
        listener = new StepCounterListener(stepsCountTextView,stepsCountProgressBar);
        listenerStepC = new StepCounterListener(stepsCountTextView,stepsCountProgressBar);
            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    if (mSensorSC != null){
                        ...
                        mSensorManager.registerListener(listenerStepC,mSensorSC,SensorManager.SENSOR_DELAY_NORMAL);
                    }
                    else{
                        Toast.makeText(getContext(),R.string.sc_not_available,Toast.LENGTH_SHORT).show();
                    }
                    ...
                    mSensorManager.unregisterListener(listenerStepC);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            ...
            // TODO 7: Uncomment the following code
                ...
                if ((curTime - lastUpdate) > 1000) {
                    ...
                    //Log.d("ACC", "X: " + String.valueOf(x) + " Y: " + String.valueOf(y) + " Z: "
                         //   + String.valueOf(z) + " t: " + String.valueOf(date)+ " mACC: "+ accMag);
            ...
            case Sensor.TYPE_STEP_DETECTOR:
                ...
                mAndroidStepCount += 1;
                Log.d("ST STEPS: ", String.valueOf(mAndroidStepCount));
